...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-04-28 08:08`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/da8e0eb0-be8b-4bac-b403-839acc5ea5c5.git
$ cd da8e0eb0-be8b-4bac-b403-839acc5ea5c5
```
